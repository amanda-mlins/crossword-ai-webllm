    ...
    <table class="border-collapse">
      ...
      <tr>
        ...
        <th
          v-for="(_, c) in grid[0]"
          :key="'col-' + c"
          class="w-8 h-8 text-center border border-gray-400 bg-violet-200 font-mono"
        >
          {{ c + 1 }}
        </th>
      </tr>
      ...
      <tbody>
       <tr v-for="(row, r) in grid" :key="r">
          <!-- Row number -->
          <th
            class="w-8 h-8 text-center border border-gray-400 bg-emerald-100 font-mono"
          >
            {{ r + 1 }}
          </th>
          ...
          <td 
            ...
            :class="[
                          cell.value == ' ' ? 'bg-rose-50' : 'bg-yellow-100',
