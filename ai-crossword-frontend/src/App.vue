<template>
  <div class="p-6 bg-gray-50 min-h-screen text-gray-800">
    ...
    <div class="flex justify-center mt-6">
      <CrosswordGrid v-if="grid" :grid="grid" :clues="clues" :highlightedClueKey="highlightedClueKey" :highlightedCluesWord="highlightedCluesWord" :revealedClues="revealedClues" @hoverWord="highlightedPosition = $event" @leaveWord="highlightedPosition = {}" />
    </div>
    <div class="flex justify-center mt-6">
      <ClueGrid v-if="clues" :clues="clues" :highlightedPosition="highlightedPosition" :highlightedCluesWord="highlightedCluesWord" @hoverClue="highlightedClueKey = $event"
